axisIntervals <- function(side=1, atTick1=monthBegin.5, atTick2=monthEnd.5,
...
axesIntervals <- function(side=1:2, atTick1=monthBegin.5,
                          atTick2=monthEnd.5, atLabels=monthMid,
